        ...
        <v-row>
          ...
          >
            <v-card>
              <v-card-title>
                <h4>{{ item.name }}</h4>
                <small> pasoudhfoashfohasdopfgpaisdgfpsudgfiopasdgfoiagsdofigaspdufhaosindvobaspodufbhpiasudf</small>
              </v-card-title>
  ...
  export default {
    data: () => ({
      ...
      items: [
        {
          name: 'Frozen Yogurt',
          calories: 'aosuidhaiosdhoiabosdfgp9asugdpfbasipdvgpasbvdipfvpasudgbfpvbaspdifbpasf',
          fat: 6.0,
          carbs: 24,
          protein: 4.0,
          sodium: 87,
